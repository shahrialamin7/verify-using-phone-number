                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <?php
                                                $currentMethod = $global_response_brand['response'][0]['verification_method'] ?? 'transaction_id';
                                            ?>
                                            <select class="form-select" id="verification_method" name="verification_method" required>
                                                <option value="transaction_id" <?= ($currentMethod === 'transaction_id') ? 'selected' : '' ?>>Transaction ID (Legacy)</option>
                                                <option value="phone_number" <?= ($currentMethod === 'phone_number') ? 'selected' : '' ?>>Phone Number</option>
                                            </select>
                                        </div>
                                        <small class="form-hint">
                                            Phone Number: Auto-detects payment via SMS matching. Transaction ID: User manually enters transaction ID.
                                        </small>
                                    </div>
                                </div>
